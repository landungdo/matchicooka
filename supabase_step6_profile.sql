-- ============================================================
-- matchicooka — Step 6: remember customer phone + reorder support
-- Run once in SQL Editor.
-- ============================================================

alter table public.profiles add column if not exists phone text;

-- place_order v4: same as v3, but also remembers the customer's phone on their profile
...
begin
  ...
  update public.profiles set phone = p_phone where id = auth.uid();  -- remember for next time
